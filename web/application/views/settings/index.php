    ...
    <div class="control-group success">
        ...
        <div class="controls">
            <select name="monitor_sqlserver" id="monitor_oracle" class="input-small">
                <option value="1" <?php echo set_selected(1,$settings['monitor_sqlserver']) ?> ><?php echo $this->lang->line('on'); ?></option>
                <option value="0" <?php echo set_selected(0,$settings['monitor_sqlserver']) ?> ><?php echo $this->lang->line('off'); ?></option>
            </select>
            <span class="help-inline"></span>
        </div>
    </div>
